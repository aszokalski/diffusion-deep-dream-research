## Exploration
This directory contains exploratory code that was used to understand the domain, perform sanity checks and initially validate / fine-tune the method. Like a scratchpad.
